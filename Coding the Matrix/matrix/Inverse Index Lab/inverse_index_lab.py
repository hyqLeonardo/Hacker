...
def andSearch(inverseIndex, query):
    ...
    init = { x for x in inverseIndex[query[0]] }
    update = set()
        
    for word in query[1: ]:
        temp = { x for x in inverseIndex[word] }
        update = { i for i in temp if i in init }
        init = update
